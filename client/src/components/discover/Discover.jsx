...
const Discover = () => {
  ...
  return (
    <>
      ...
      <ThemesDisplay />
      {/*Themes  */}
      <div className="rounded-lg mt-[2rem] flex flex-col items-center justify-center">
        <button
        ...
        <div
          className={`text-[1.3rem] overflow-y-scroll flex flex-col mt-[1rem] w-[9rem] font-bold text-custom-lightBlue font-serif active:transition-transform transition-all duration-300 ease-in-out ${
      ...
      <div className="">
        <div className="flex flex-row flex-wrap justify-evenly items-center mb-[4rem]">
          <StoryCard />
          <StoryCard />
          <StoryCard />
          <StoryCard />
