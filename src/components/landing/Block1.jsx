  ...
  return (
    <div className="flex flex-col justify-center items-center mt-[5vh] font-serif mx-20">
      <div className="flex flex-col justify-center items-center my-20">
        <p className="text-5xl text-custom-lightBlue">
      ...
      <div className="border-2 border-custom-lightGray mx-[30vh] text-custom-lightBlue ">
        ...
        <div className="relative h-[50vh] w-[60vw] overflow-y-scroll">
          ...
          <article className="p-5 text-[1rem] text-white bg-custom-lightBlue/65 absolute w-[59.6vw]">
            ...
            wondered what it would be this time. Coolers need stocking, Jenny.
            Jenny, we're almost completely out of forks. Another Code Brown all
            over the ladies' room. Where's Jenny? <br />
            Sometimes I hated this tourist trap so much. I longed for September.
            For crisp afternoons, walking with Paul, turning the day's
            complaints into jokes and talking about Our Big Plans. But high
            school was over now.
            ...
            <br />
            For once, Leo's eyes weren't critical, though. Instead something
            wild shone in their depths. <br />
            ...
            "But it's happening other places, too. Other animals. All coming
            down from the sky."
          </article>
        </div>
      </div>
